...
import {  Form, Input,Select,Upload, notification,Button, Image } from 'antd';
import { UploadOutlined } from '@ant-design/icons';
import { CustomButton } from '../../../../components/Button/CustomButton';
import { uploadImageToStorage } from '../../../../config/uploadFile';
import useStore from '../../../../zustand/store/store';
import { fetchBusiness, selector } from '../../../../zustand/store/store.provide';
...
export const MyBusiness = () => {
  ...
  return (
    <div className='flex flex-wrap'>
      ...
      autoComplete="off"
      >
          <h3 className=' font-bold text-3xl mb-4'>Add Business</h3>
